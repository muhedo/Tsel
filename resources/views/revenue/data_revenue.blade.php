                    ...
                    @foreach ($revenue as $Revenue)
                        <tr>
                            ...
                            <td style="text-align: center">
                              ...
                              <a href="{{ url('revenue/delete/'.$Revenue->id_revenue) }}" class="btn btn-danger btn-flat btn-sm" onclick="return confirmDelete(this)"><i class="fa fa-trash"></i> delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Data Revenue</h4>
